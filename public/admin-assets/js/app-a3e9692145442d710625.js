	...
	var Buttons = function (_React$Component) {
	  ...
	  _createClass(Buttons, [{
	    ...
	    value: function render() {
	      ...
	      var actionsMoveTo = [_react2.default.createElement(FlatButton, {
	        label: _locales2.default.actions.cancel,
	        primary: true,
	        onTouchTap: this.closeMoveTo
	      ...
	      var actionsDelete = [_react2.default.createElement(FlatButton, {
	        label: _locales2.default.actions.cancel,
	        primary: true,
	        onTouchTap: this.closeDelete
	      }), _react2.default.createElement(FlatButton, {
...
//# sourceMappingURL=app-a3e9692145442d710625.js.map