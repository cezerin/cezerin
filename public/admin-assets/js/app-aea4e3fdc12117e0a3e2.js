...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"customers": {
			...
			"name": "Customer name",
			"aboutDelete": "{count} customers is about to be permanently deleted. You can’t undo this action.",
...
/***/ function(module, exports, __webpack_require__) {
	...
	}, _defineProperty(_initialState, 'isFetchingItems', false), _defineProperty(_initialState, 'filter_search', ''), _initialState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return {
	    ...
	    productCategory: state.productCategories.items.find(function (item) {
	  ...
	  _createClass(AppBarTop, [{
	    ...
	    value: function render() {
	      ...
	      var _props = this.props,
	          ...
	          productCategory = _props.productCategory,
	      ...
	      if (location === '/admin/products') {
	        ...
	        if (productCategory) {
	          title = _react2.default.createElement(
	            'span',
	            null,
	            _locales2.default.products.title,
	            _react2.default.createElement(
	              _FontIcon2.default,
	        ...
	        if (productsSelectedCount > 0) {
	          title = _locales2.default.selected + ' (' + productsSelectedCount + ')';
	        }
	        ...
	        if (customerGroup) {
	          title = _react2.default.createElement(
	            'span',
	            null,
	            _locales2.default.customers.title,
	            _react2.default.createElement(
	              _FontIcon2.default,
	              { style: { top: 6 }, color: '#fff', className: 'material-icons' },
	              'chevron_right'
	        ...
	        if (customersSelectedCount > 0) {
	          title = _locales2.default.selected + ' (' + customersSelectedCount + ')';
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	//     let filter = { limit: 50, fields: 'id,name,group_id,Group_name,sku,images,active,discontinued,stock_status,stock_quantity,price,currency,on_sale,regular_price' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _select = __webpack_require__(/*! modules/customer-groups/select */ 1153);
	  ...
	  _createClass(Buttons, [{
	    ...
	    value: function render() {
	      ...
	      var actionsSetGroup = [_react2.default.createElement(_FlatButton2.default, {
	        ...
	        label: _locales2.default.actions.save,
	        primary: true,
	        keyboardFocused: true,
	      ...
	      return _react2.default.createElement(
	        ...
	        selectedCount > 0 && _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _locales2.default.customers.aboutDelete.replace('{count}', selectedCount)
	          ),
	          _react2.default.createElement(
	            _Dialog2.default,
	            {
	              title: _locales2.default.customers.setGroup,
	        ...
	        _react2.default.createElement(
	          ...
	          selectedCount > 0 && _react2.default.createElement(_MenuItem2.default, { primaryText: _locales2.default.customers.setGroup, onTouchTap: this.showSetGroup })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  return _react2.default.createElement(_TextField2.default, {
	    ...
	    hintText: _locales2.default.customers.search,
	    underlineShow: false,
	    style: { float: 'left' },
	...
	exports.default = function () {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: 'col-xs-3 col--no-gutter scroll col-categories' },
	      _react2.default.createElement(_list4.default, { showAll: true, showRoot: false, showAdd: false })
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'col-xs-9 col--no-gutter scroll' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// fetchMoreCustomers,  createProduct
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actions2 = __webpack_require__(/*! ../../customers/actions */ 849);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          showRoot && _react2.default.createElement(_List.ListItem, {
	            primaryText: _locales2.default.customers.noGroup,
	            style: 'root' === selectedId ? styles.selectedItem : styles.item,
	            innerDivStyle: styles.innerItem,
	            leftIcon: _react2.default.createElement(
	              _FontIcon2.default,
...
/* 1153 */
/*!******************************************************************!*\
  !*** ./src/admin/client/modules/customer-groups/select/index.js ***!
  \******************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
//# sourceMappingURL=app-aea4e3fdc12117e0a3e2.js.map