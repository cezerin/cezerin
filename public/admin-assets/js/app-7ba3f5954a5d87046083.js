...
/***/ function(module, exports, __webpack_require__) {
	...
	//   return (dispatch, getState) => {
	//     const state = getState();
	//     let promises = state.customers.selected.map(customerId => api.customers.update(customerId, { category_id: category_id }));
	//
	//     return Promise.all(promises).then(values => {
...
//# sourceMappingURL=app-7ba3f5954a5d87046083.js.map