...
/***/ function(module, exports, __webpack_require__) {
	...
	function sendUpdateGroup(id, data) {
	  return function (dispatch) {
	    dispatch(requestUpdateGroup(id));
	    return _api2.default.customer_groups.update(id, data).then(function (_ref2) {
	      var status = _ref2.status,
	          json = _ref2.json;
	...
	function updateGroup(data) {
	  return function (dispatch, getState) {
	    return dispatch(sendUpdateGroup(data.id, data));
	  };
	}
	
	function createGroup() {
	  return function (dispatch, getState) {
	    return _api2.default.customer_groups.create({ active: false }).then(function (_ref3) {
	      var status = _ref3.status,
	          json = _ref3.json;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return _react2.default.createElement(
	    "div",
	    { className: "row row--no-gutter col-full-height" },
	    _react2.default.createElement("div", { className: "col-xs-3 col--no-gutter scroll col-categories" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reduxForm.reduxForm)({ form: 'FormCustomerGroup', validate: validate, enableReinitialize: true })(Form);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    ...
	    onCreate: function onCreate() {
	      dispatch((0, _actions.createGroup)());
	    }
	  };
	};
...
//# sourceMappingURL=app-ab5c174ab7f3f42a5495.js.map