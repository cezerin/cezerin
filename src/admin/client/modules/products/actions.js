...
export function fetchProducts() {
  return (dispatch, getState) => {
    ...
    if (!state.products.isFetching) {
      ...
      let filter = { limit: 20, fields: 'id,name,category_id,category_name,sku,images,active,discontinued,stock_status,stock_quantity,price,on_sale,regular_price' };
...
export function fetchMoreProducts() {
  return (dispatch, getState) => {
    ...
    let filter = { limit: 50, fields: 'id,name,category_id,category_name,sku,images,active,discontinued,stock_status,stock_quantity,price,on_sale,regular_price' };
