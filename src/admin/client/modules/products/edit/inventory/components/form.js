...
class ProductInventoryForm extends React.Component {
  constructor(props) {
    super(props);
  }
        ...
        <form onSubmit={handleSubmit} style={{ display: 'initial' }}>
              <Paper className="paper-box" zDepth={1}>
                <div className={style.innerBox}>
                  ...
                  <Field name="stock_tracking" component={CustomToggle} label={messages.products_stockTracking}/>
                  <Divider style={{
                    marginTop: 10,
                    marginBottom: 10
                  }}/>
                  <Field name="stock_preorder" component={CustomToggle} label={messages.products_stockPreorder}/>
                  <Divider style={{
                    marginTop: 10,
                    marginBottom: 10
                  }}/>
                  <Field name="stock_backorder" component={CustomToggle} label={messages.products_stockBackorder}/>
                  <Divider style={{
                    marginTop: 10,
                    marginBottom: 10
                  }}/>
