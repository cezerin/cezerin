...
describe('Products', () => {
	...
	let product, options, variants, optionValues, variantsOptions;
	...
	describe('/POST products', function() {
		...
		it('should POST new values to existing options for an existing product', function(done) {
			...
			chai
				.request(server)
				.post(`/api/v1/products/${product.id}/options/${options[0].id}/values`)
		...
		it('should UPDATE single value for a single option for a single product', function(done) {
			...
			chai
				...
				.end((err, res) => {
					res.should.have.status(200);
					res.should.be.a('object');
					res.body[0].should.have.property('name').eql('Updated Option Values');
					done();
				});
		});
	});
...
// this.router.get('/v1/products/:productId/images',this.getImages.bind(this)
//
// this.router.post('/v1/products/:productId/images',this.addImage.bind(this)
//
// this.router.put('/v1/products/:productId/images/:imageId',this.updateImage.bind(this)
//
// this.router.delete('/v1/products/:productId/images/:imageId',this.deleteImage.bind(this)
//
